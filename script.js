...
const chistan = [
  {
    answer: "نوار",
    description: "آن چیست که چه پر باشد و چه خالی وزنش یکی است؟",
  },
  {
    answer: "موج",
    description: "آن چیست که در رادیو و دریا مشترک و هردو آن را دارند؟",
  },
  {
    answer: "دندان",
    description: "آن چیست سفید است قند نیست ریشه دارد درخت نیست؟",
  },
  {
    answer: "غاز",
    description:
  ...
  {
    answer: "ناودان",
    description: "آن چیست که با گریستن آسمان اشک آن روان می شود؟",
  },
  {
    answer: "لامپ",
    description:
  ...
  {
    answer: "قلم نی",
    description: "آن چیست می خورد خون سیاه می رود راه سفید؟",
  },
  {
    answer: "ادویه",
    description:
  ...
  { answer: "خواب", description: " آن چیست که همه می بینند ولی خدا نمی بیند؟" },
  {
    answer: "بهشت",
    description:
      "چهار حرف است نام مطلوبی. که تمنای اهل عالم گشت. هست جهانی چنان عجیب. یکی اگر کم کنی بماند هشت؟",
  },
  { answer: "راز", description: "آن چیست که با یک نجوا می توان شکست؟" },
  {
    answer: "قیچی",
    description:
      " آن چیست که دوچشم دارد و وقتی انگشت به چشمانش فرو می کنی گوشهایش تیز می شود؟",
  },
  {
    answer: "حرف ق",
    description:
      " آن چیست که در هر قرن یک بار و در هر دقیقه دوبار می آید ولی درسال هیچ وقت نمی آید؟",
  },
  {
    answer: "اشک چشم",
    description:
      "چیست آن، كز چشمه ای آید برون. می شود از سنگ سختی سر نگون. مدتی بر دشت خشكی چون برفت. بیرون و درون شهر جایی دارد؟",
  },
  {
    answer: "چغندر",
    description:
      " آن چیست كه ارغوان قبایی دارد. مانند دم موش پایی دارد. گرد است و مدور است و تاجش بر سر. صد پاره تنش، ولی ز یك پایه نگون؟",
  },
  {
    answer: "عنکبوت",
    description:
      "آن چیست كه خود ریسد و خود بافد جامه. پوست در پوست گرد یكدیگر؟",
  },
  {
    answer: "خربزه",
    description:
      "آن چیست كه پا و سر ندارد. جز نام دو جانور ندارد اندر شكمش ستارگانند. اندام ظریف چون صنوبر دارد؟",
  },
  {
    answer: "لیمو شیرین",
    description:
      "آن چیست قبای زرد در بر دارد. تلخ است ولی طعمی چو شكر دارد زرد است و معطر آید به مشام. با هزاران سوار می گردد؟",
  },
  {
    answer: "لاکپشت",
    description:
      "سخت است نه كه سنگ. بیابان گرد است نه كه مرد است. تخم ریز است نه كه مرغ است. كلید آهنین قفلش گشاید؟",
  },
  {
    answer: "قلیان",
    description:
      "چیست آن مرغ آتشین منقار و قنا عذاب النار؟ شب و روز اندر آب می گوید. سرخ و سبز و سپید پوشیده؟",
  },
  {
    answer: "ملخ",
    description:
      "یك معما از تو پرسم ای حكیم پر هنر. پای او مانند اره، شیر سینه، اسب سر، مور چشم ،مار دم ،كركس پرو عقرب شكم.نیم پر شد پر تهی، یعنی چه چیز؟",
  },
  {
    answer: "شراب",
    description:
      "شیراز پری رخان مهوش دارد. بنگر كه دلم از تو چه خواهش دارد از هر سر مصرعی حروفی بردار. نه در دارد نه دیوار و حصاری؟",
  },
];
...
InputWord.forEach((items, index) => {
  items.addEventListener("keyup", function (event) {
    ...
    if ((event.key >= 0) & (event.key <= 9)) items.value = "";
    if (
      ...
      if (index === InputWord.length - 1) items.value = event.key;
    ...
    if ((event.key === "Backspace") & (index === 0)) answerbox[index] = "";
